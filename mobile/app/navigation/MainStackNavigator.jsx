...
import CreateLivestreamScreen from "../screens/CreateLivestream/CreateLivestreamScreen"
...
const MainStackNavigator = () => {
  ...
  const initialRouteName = user?.role === "admin" ? "AdminDashboard" : "Dashboard"
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="MobileNumberRegistration" component={MobileNumberRegistrationScreen} />
      <Stack.Screen name="AccountDetailsCreation" component={AccountDetailsCreationScreen} />

      {/* Verification */}
      <Stack.Screen name="EmailSentVerification" component={EmailSentVerificationScreen} />
      <Stack.Screen name="MobileNumberVerification" component={MobileNumberVerificationScreen} />

      {/* Dashboard */}
      <Stack.Screen name="Cart" component={CartScreen} />
      <Stack.Screen name="PartnershipOptions" component={PartnershipOptionsScreen} />
      ...
      <Stack.Screen name="EditMobileNumber" component={EditMobileNumberScreen} />

      {/* Partnership Options*/}
      {/* Seller */}
      <Stack.Screen name="SellerWelcome" component={SellerWelcomeScreen} />
      <Stack.Screen name="SellerAccountType" component={SellerAccountTypeScreen} />
      <Stack.Screen name="SellerRegistrationForm" component={SellerRegistrationFormScreen} />
      <Stack.Screen name="SellerAddressSetup" component={SellerAddressSetupScreen} />
      <Stack.Screen name="SellerReviewSubmit" component={SellerReviewSubmitScreen} />
      <Stack.Screen name="SellerSubmissionSuccess" component={SellerSubmissionSuccessScreen} />
      <Stack.Screen name="SellerApplicationStatus" component={SellerApplicationStatusScreen} />

      {/* Delivery Partner */}
      <Stack.Screen name="DeliveryPartnerWelcome" component={DeliveryPartnerWelcomeScreen} />
      <Stack.Screen name="DeliveryPartnerRegistrationForm" component={DeliveryPartnerRegistrationFormScreen} />
      <Stack.Screen name="DeliveryPartnerReviewSubmit" component={DeliveryPartnerReviewSubmitScreen} />
      <Stack.Screen name="DeliveryPartnerSubmissionSuccess" component={DeliveryPartnerSubmissionSuccessScreen} />
      <Stack.Screen name="DeliveryPartnerApplicationStatus" component={DeliveryPartnerApplicationStatusScreen} />

      {/* Admin */}
      <Stack.Screen name="AdminSellerApplicationDetails" component={AdminSellerApplicationDetailsScreen} />
      <Stack.Screen
      ...
      <Stack.Screen name="SellerChatConversation" component={SellerChatConversationScreen} />
      <Stack.Screen name="EditProduct" component={EditProductScreen} />
      <Stack.Screen name="CreateLivestream" component={CreateLivestreamScreen} />

      {/* Delivery Partner Dashboard */}
      <Stack.Screen name="DeliveryPartnerDashboard" component={DeliveryPartnerDashboardScreen} />
      <Stack.Screen name="EditDeliveryPartnerProfile" component={EditDeliveryPartnerProfileScreen} />
      <Stack.Screen name="DeliveryPartnerDeliveryDetails" component={DeliveryPartnerDeliveryDetailsScreen} />
