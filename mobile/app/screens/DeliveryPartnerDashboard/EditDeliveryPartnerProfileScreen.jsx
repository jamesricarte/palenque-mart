...
const EditDeliveryPartnerProfileScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    if (deliveryPartnerProfile) {
      setFormData({
        ...
        emergency_contact_name: deliveryPartnerProfile.emergency_contact_name || "",
        emergency_contact_phone: deliveryPartnerProfile.emergency_contact_phone || "",
        emergency_contact_relation: deliveryPartnerProfile.emergency_contact_relation || "",
      })
    }
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.put(`${API_URL}/api/delivery-partner/profile`, formData, {
        headers: {
  ...
  return (
    <>
      ...
      <View className="flex flex-row items-center justify-between px-4 pt-16 pb-5 bg-white border-b border-gray-300">
        ...
        >
          <Text className="font-semibold text-white">{loading ? "Saving..." : "Save"}</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView className="flex-1 bg-gray-50">
        <View className="p-4">
          ...
          <View className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            <Text className="mb-4 text-lg font-semibold text-gray-900">Vehicle Information</Text>

            <View className="mb-4">
              <Text className="mb-2 text-sm font-medium text-gray-700">Vehicle Make</Text>
              <TextInput
            ...
            <View className="mb-4">
              <Text className="mb-2 text-sm font-medium text-gray-700">Vehicle Year</Text>
              <TextInput
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange("vehicle_color", value)}
            ...
            <View className="mb-4">
              <Text className="mb-2 text-sm font-medium text-gray-700">Company Name (Optional)</Text>
              <TextInput
          ...
          {/* Emergency Contact */}
          <View className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            <Text className="mb-4 text-lg font-semibold text-gray-900">Emergency Contact</Text>

            <View className="mb-4">
              <Text className="mb-2 text-sm font-medium text-gray-700">Contact Name</Text>
              <TextInput
            ...
            <View className="mb-4">
              <Text className="mb-2 text-sm font-medium text-gray-700">Contact Phone</Text>
              <TextInput
            ...
            <View className="mb-4">
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange("emergency_contact_relation", value)}
            ...
            <View className="flex flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-sm text-blue-700">
                  Some information like vehicle type, license number, and registration cannot be changed here. Contact
                  support if you need to update these details.
                </Text>
              </View>
            </View>
          </View>
